...
public class Main {
	...
	public static void modificarJugador () {
        ...
        if (jugadorEncontrado != null) {
            ...
            System.out.print("Ingresar el nuevo nombre del jugador: ");
            jugadorEncontrado.setNombre(scanner.next());
            
            System.out.print("Ingresar el nuevo apellido del jugador: ");
            jugadorEncontrado.setApellido(scanner.next());
            scanner.nextLine();
            
            System.out.println("Ingresar la nueva fecha de nacimiento del jugador (dd/mm/yyyy): ");
            ...
            System.out.println("Ingresar la nueva nacionalidad del jugador: ");
            jugadorEncontrado.setNacionalidad(scanner.next());
            
            System.out.println("Ingresar la nueva estatura en"+ " cm "+"del jugador: ");
            jugadorEncontrado.setEstatura(scanner.nextInt());
            
            System.out.println("Ingresar el nuevo peso del jugador: ");
            jugadorEncontrado.setPeso(scanner.nextInt());
            
            System.out.println("Ingresar la nueva posicion del jugador: ");
